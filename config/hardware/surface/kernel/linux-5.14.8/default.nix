...
let
  ...
  surface_kernelPatches = [
    {
      name = "microsoft-surface-patches-linux-5.14.8";
      patch = null;
    ...
    }
    {
      ...
      patch = patches + "/5.14/0005-surface-sam-over-hid.patch";
    }
    {
      name = "ms-surface/0006-surface-sam";
      patch = patches + "/5.14/0006-surface-sam.patch";
    }
    {
      name = "ms-surface/0007-surface-hotplug";
      patch = patches + "/5.14/0007-surface-hotplug.patch";
    }
    {
      name = "ms-surface/0008-surface-typecover";
      patch = patches + "/5.14/0008-surface-typecover.patch";
    }
    {
      name = "ms-surface/0009-cameras";
      patch = patches + "/5.14/0009-cameras.patch";
    }
    {
      name = "ms-surface/0010-amd-gpio";
      patch = patches + "/5.14/0010-amd-gpio.patch";
    }
    {
      name = "ms-surface/0011-amd-s0ix";
      patch = patches + "/5.14/0011-amd-s0ix.patch";
    }
  ];
in (with pkgs;
  recurseIntoAttrs (linuxPackagesFor (callPackage ./linux-5.14.8.nix {
